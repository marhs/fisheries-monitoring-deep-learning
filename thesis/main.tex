...
\thesistitle{Fish recognition using deep learning} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\department{\href{http://department.university.com}{Departamento de ciencias de la compucación e inteligencia artificial}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
