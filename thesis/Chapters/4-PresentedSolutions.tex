...
Todos los modelos de redes convolucionales que se van a entrenar en este proyecto han sido entrenados usando Keras sobre cuadernos de \textit{iPython}. La estructura de desarrollo y algunas utilidades están descritas en \parencite{fastai} y \parencite{felixyu}.
...
La puntuación total para este conjunto de test sería $1.906$. Esto es sobre un conjunto de test muy pequeño, solo el 20 \% del conjunto de entrenamiento. 
